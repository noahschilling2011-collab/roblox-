...
Luau-Compiler, und 70 Logik-/Balancing-/Design-Tests in einer echten Luau-VM. Nicht geprüft ist
...
70 Tests in einer echten Luau-VM (WASM) plus Syntaxprüfung aller `src/`-Dateien im
