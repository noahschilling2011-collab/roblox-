...
Luau-Compiler, und 72 Logik-/Balancing-/Design-Tests in einer echten Luau-VM. Nicht geprüft ist
...
72 Tests in einer echten Luau-VM (WASM) plus Syntaxprüfung aller `src/`-Dateien im
