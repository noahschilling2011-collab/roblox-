...
Luau-Compiler, und 91 Logik-/Balancing-/Design-Tests in einer echten Luau-VM. Nicht geprüft ist
...
91 Tests in einer echten Luau-VM (WASM) plus Syntaxprüfung aller `src/`-Dateien im
