...
Luau-Compiler, und 92 Logik-/Balancing-/Design-Tests in einer echten Luau-VM. Nicht geprüft ist
...
92 Tests in einer echten Luau-VM (WASM) plus Syntaxprüfung aller `src/`-Dateien im
